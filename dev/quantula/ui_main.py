...
pixelConversionButton = tk.Button(pixelConversionFrame, text="Pixel Conversion", width=10, height=2, justify=CENTER, wraplength=100, command=lambda: windows.convert_background_window(root))
...
sharpnessAdjustButton = tk.Button(imageAdjustmentFrame, text="Sharpness Adjustment", width=10, height=2, justify=CENTER, wraplength=100)
sharpnessAdjustButton.grid(row=3, column=0, padx=10, pady=5, sticky="w")

#Button for performing saturation adjustment
sharpnessAdjustButton = tk.Button(imageAdjustmentFrame, text="Saturation Adjustment", width=10, height=2, justify=CENTER, wraplength=100)
...
kmeansCluteringButton = tk.Button(colorClusteringFrame, text="K-means clustering", width=10, height=2, justify=CENTER, wraplength=100)
