...
tabControl.add(dataManagementTab, text ='Data Manager', image=dataManagementIcon, compound=TOP)
...
dataViewerFrame = tk.LabelFrame(dataManagementTab, text="Data Viewer")
dataViewerFrame.grid(row=1, column=1, padx=10, pady=10, sticky="new")

#Direction for visualizing data
tableViewMessage = "Usage: View data generated by color quantula tools"
tableViewDirections = tk.Label(dataViewerFrame, text = tableViewMessage, wraplength=400, justify=LEFT)
tableViewDirections.grid(row=1, column=0, padx=10, pady=10)

#Button for visualizing images
viewImageButton = tk.Button(dataViewerFrame, text="Image Viewer", width=10, height=2, justify=CENTER, command=lambda: windows.view_images_window(root))
viewImageButton.grid(row=2, column=0, padx=10, pady=(5,10), sticky="w")

#Button for visualizing tables
viewTableButton = tk.Button(dataViewerFrame, text="Table Viewer", width=10, height=2, justify=CENTER, command=lambda: windows.view_tables_window(root))
viewTableButton.grid(row=3, column=0, padx=10, pady=(5,10), sticky="w")
