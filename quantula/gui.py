...
#####   TABLE VIEWER FRAME #####
tableViewerFrame = tk.LabelFrame(dataManagementTab, text="Data Viewer")
tableViewerFrame.grid(row=1, column=1, padx=10, pady=10, sticky="new")

#Direction for upoading data
tableViewMessage = "Usage: View tables generated by color quantification run"
tableViewDirections = tk.Label(tableViewerFrame, text = tableViewMessage, wraplength=400, justify=LEFT)
tableViewDirections.grid(row=1, column=0, padx=10, pady=10)

#Button for importing data window
viewTableButton = tk.Button(tableViewerFrame, text="Table Viewer", width=10, height=2, justify=CENTER, command=lambda: windows.view_tables_window(root))
viewTableButton.grid(row=2, column=0, padx=10, pady=(5,10), sticky="w")
